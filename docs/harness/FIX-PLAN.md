...
| W3 (partial) | 🟡 **layering gate shipped** (gate 2c, ISSUE-017) — its first run found a real `db ↔ services` module cycle that Rust compiled without complaint. The **giant-file split is not done**: `services/history_service.rs` is still 1352 lines, and those "pure moves" carry more review risk than the gate did.                                                                        |
| W4, W5, W6   | ⬜ not started — scoped and sequenced in the wave table above                                                                                                                                                                                                                                                                                                                       |
