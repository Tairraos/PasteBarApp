...
| `app_ready`                                      | `src-tauri/src/main.rs`                               | yes                 |
| `autostart`                                      | `src-tauri/src/main.rs`                               | yes                 |
| `build_system_menu`                              | `src-tauri/src/menu.rs`                               | yes                 |
| `change_menu_language`                           | `src-tauri/src/commands/translations_commands.rs`     | yes                 |
| `check_osx_accessibility_preferences`            | `src-tauri/src/main.rs`                               | yes                 |
...
| `cmd_check_custom_data_path`                     | `(main.rs or re-export)`                              | yes                 |
| `cmd_create_directory`                           | `(main.rs or re-export)`                              | yes                 |
| `cmd_get_all_settings`                           | `(main.rs or re-export)`                              | **no**              |
| `cmd_get_custom_db_path`                         | `(main.rs or re-export)`                              | yes                 |
| `cmd_get_setting`                                | `(main.rs or re-export)`                              | **no**              |
| `cmd_remove_setting`                             | `(main.rs or re-export)`                              | **no**              |
| `cmd_revert_to_default_data_location`            | `(main.rs or re-export)`                              | yes                 |
| `cmd_set_and_relocate_data`                      | `(main.rs or re-export)`                              | yes                 |
| `cmd_set_setting`                                | `(main.rs or re-export)`                              | **no**              |
| `cmd_validate_custom_db_path`                    | `(main.rs or re-export)`                              | yes                 |
...
| `get_app_settings`                               | `src-tauri/src/main.rs`                               | yes                 |
...
| `get_device_id`                                  | `src-tauri/src/main.rs`                               | yes                 |
...
| `is_autostart_enabled`                           | `src-tauri/src/main.rs`                               | yes                 |
...
| `open_history_window`                            | `src-tauri/src/main.rs`                               | yes                 |
| `open_osx_accessibility_preferences`             | `src-tauri/src/main.rs`                               | yes                 |
| `open_path_or_app`                               | `src-tauri/src/main.rs`                               | yes                 |
| `open_quickpaste_window`                         | `src-tauri/src/main.rs`                               | yes                 |
| `path_type_check`                                | `src-tauri/src/commands/shell_commands.rs`            | yes                 |
| `quickpaste_hide_paste_close`                    | `src-tauri/src/main.rs`                               | yes                 |
...
| `set_icon`                                       | `src-tauri/src/main.rs`                               | **no**              |
...
| `update_left_click_tray_env`                     | `src-tauri/src/main.rs`                               | yes                 |
...
| `update_setting`                                 | `src-tauri/src/main.rs`                               | yes                 |
...
| `window-events`                              | `src-tauri/src/main.rs`                        | `packages/pastebar-app-ui/src/App.tsx`                                               |
